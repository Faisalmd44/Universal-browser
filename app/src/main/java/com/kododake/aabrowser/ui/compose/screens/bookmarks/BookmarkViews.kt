...
object BookmarkViews {

    fun createBookmarkManagerContent(
        context: Context,
        isVisibleState: State<Boolean>,
        bookmarksState: State<List<BookmarkItemUi>>,
        canAddCurrentUrlState: State<Boolean>,
        currentUrlState: State<String>,
        ...
        return ComposeView(context).apply {
            ...
            setContent {
                BookmarkManagerSheet(
                    ...
                    canAddCurrentUrl = canAddCurrentUrlState.value,
